...
const Posts = ( ) => {
  ...
  const fetchPosts = async () => {
    const response = await fetch("https://postshare-backend.onrender.com/api/posts/fetchAllPosts");
  ...
  const handleLikes = async (post) => {
    ...
    const response = await fetch('https://postshare-backend.onrender.com/api/profile/like', {
      method: 'POST',
      headers: {
