  ...
  const postImage = async (e) => {
    ...
    if (image !== null) {
      ...
      try {
        ...
        const response = await fetch("https://postshare-backend.onrender.com/api/posts/upload", {
          method: "POST",
          body: formData,
        });
      ...
      try {
        ...
        const response = await fetch("https://postshare-backend.onrender.com/api/posts/upload/video", {
          method: "POST",
          body: formData,
        });
