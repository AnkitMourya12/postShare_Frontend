...
const FollowersCard = () => {
    ...
    const fetchUsers = async () => {
        const response = await fetch("https://postshare-backend.onrender.com/api/users/fetchUsers");
    ...
    const handleFollow = async (follwoerId) => {
        ...
        const response = await fetch('https://postshare-backend.onrender.com/api/profile/follow', {
            method: 'POST',
            headers: {
